...
type Result = { signedUrl: string; expires_at: string; roomId: string; roomCode: string };
  ...
  return <>
    ...
    <div className="grid2" style={{ alignItems: "start", marginTop: 30 }}>
      <div className="glass card" style={{ display: "grid", placeItems: "center" }}>
        <Image unoptimized src={result.signedUrl} alt="Strip photobox hasil sesi" width={1200} height={1800} style={{ width: "min(100%,440px)", height: "auto", borderRadius: 12 }} />
      </div>
      <div className="glass card">
        ...
        <div style={{ display: "grid", gap: 10 }}>
          <button className="btn btn-primary" onClick={download}><Download size={18} />Unduh WebP</button>
